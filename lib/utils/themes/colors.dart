...
class GFColors {
  ...
  static const kPrimary800Color = Color(0xFF181818);
  static const kPrimary400Color = Color(0xff4a5568);
  static const kPrimary700Color = Color(0xFF282828);
  static const kPrimaryButtomColor = Color(0xFF38a169);
}
